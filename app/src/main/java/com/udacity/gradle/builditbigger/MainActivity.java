...
import com.srinumallidi.udacity.builditbigger.jokesdisplay.JokeDisplayActivity;
    ...
    public void tellJoke(View view) {
        mEndPointAsyncTask = new EndPointAsyncTask(){
            ...
            protected Void doInBackground(Object... params) {
                ...
                String joke = mEndPointAsyncTask.getJoke();
                Intent jokeIntent = new Intent(getApplicationContext(), JokeDisplayActivity.class);
                jokeIntent.putExtra(JokeDisplayActivity.JOKE_KEY, joke);
